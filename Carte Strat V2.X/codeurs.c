...
void debug ()
{
  ...
  /*  PutsUART(UART_XBEE, "X : [");
    ...
    PutsUART(UART_XBEE, "CONSIGNE : [");
    PutLongUART((int32_t)(DISTANCE.consigne));
    PutsUART(UART_XBEE, "], Actu : [");
    PutLongUART( (int32_t) DISTANCE.actuelle);
    PutsUART(UART_XBEE, "], Théorique : [");
    //PutLongUART((int32_t) DISTANCE.theorique);
    //PutsUART(UART_XBEE, "], VIT : [");
    PutLongUART((int32_t) VITESSE.theorique);
    PutsUART(UART_XBEE, "] \r");

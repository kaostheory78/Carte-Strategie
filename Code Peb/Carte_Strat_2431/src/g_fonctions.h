...
******************************************************************************
* Description	:	- Déclarations des prototypes des fonctions du fichier g_fonctions.c
******************************************************************************/
...
void g_config_i2c (void);

void g_config_interrupt_slave (void);

void g_config_timer0 (void);

void g_config_timer2 (void);
